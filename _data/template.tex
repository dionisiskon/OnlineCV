...
\begin{centering}
\AddToShipoutPicture*
    {\put(390,590){\includegraphics[width=4cm,height=4cm]{_data/image.jpg}}}
\end{centering}
...
$for(sidebar.urls)$
\href{http://$sidebar.urls$}{$sidebar.urls$}\\
$endfor$
\end{multicols}
$endif$
...
\emph{$education.university$}$if(education.city)$ $education.city$$endif$\\[.2cm] $if(education.details)$\subsection*{Details}$education.details$$endif$
$endfor$
$endif$
\newpage
